    ...
    <>
      <div className="fixed w-full h-[80px] flex justify-center items-center px-4 bg-[#d0cab4] text-[#997138] z-20 font-didact tracking-wider">
        <motion.ul className="hidden md:flex w-full rounded-2xl" variants={variants} initial="hidden" whileInView="visible">
          <motion.li variants={variants} className="p-3 hover:cursor-pointer hover:text-[#9e2b2b] h-full w-1/4 text-center"><p className="hover:drop-shadow-lg transition-all hover:skew-x-6 hover:tracking-widest"><Link to="home" smooth={true} duration={200}>Home</Link></p></motion.li>
          <motion.li variants={variants} className="p-3 hover:cursor-pointer hover:text-[#9e2b2b] h-full w-1/4 text-center"><p className="hover:drop-shadow-lg transition-all hover:skew-x-6 hover:tracking-widest"><Link to="information" smooth={true} duration={200}>Information</Link></p></motion.li>
          <motion.li variants={variants} className="p-3 hover:cursor-pointer hover:text-[#9e2b2b] h-full w-1/4 text-center"><p className="hover:drop-shadow-lg transition-all hover:skew-x-6 hover:tracking-widest"><Link to="booking" smooth={true} duration={200}>Booking</Link></p></motion.li>
          <motion.li variants={variants} className="p-3 hover:cursor-pointer hover:text-[#9e2b2b] h-full w-1/4 text-center"><p className="hover:drop-shadow-lg transition-all hover:skew-x-6 hover:tracking-widest"><Link to="contact" smooth={true} duration={200}>Contact</Link></p></motion.li>
        </motion.ul>
        ...
        <motion.ul className={
          ...
          <motion.li variants={variants} className="py-6 text-2xl">
